...
Nommer la première feuille Feuille 1
En ligne 1, ajouter les en-têtes : `id`, `titre`, `description`, `categorie`, `auteur`, `groupe`, `date`, `likes`, `dislikes`
En cellule Z2, écrire le texte de la page À propos
...
```
Remplacer `VOTRE_SHEET_ID_ICI` par l'ID de votre feuille (visible dans l'URL)
4. Déployer l'Apps Script
Déployer → Nouveau déploiement
Type : Application Web
Exécuter en tant que : Moi
Accès : Tout le monde
Cliquer Déployer et copier l'URL générée
